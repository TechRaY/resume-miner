...
def fit_text(data_dir_path, max_vocab_size=None, label_type=None):
    ...
    for f in os.listdir(data_dir_path):
        ...
        if os.path.isfile(data_file_path) and f.lower().endswith('.txt'):
            ...
            for line in file:
                print("FileName"+file.name + "Line "+line)
...
if __name__ == "__main__":
    fit_text('D:/Other_projects/resume/keras-english-resume-parser-and-analyzer\demo\data/training_data',label_type='line_label')